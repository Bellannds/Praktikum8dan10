...
<body>
    <form method="post" action="simpankontak.php">
        <table>
            <tr>
                <td>ID</td><td><input type="text" onkeyup="isi_otomatis()" name="id"></td>
            </tr>
            <tr>
                <td>NAMA</td><td><input type="text" name="nama"></td>
            </tr>
            <tr>
                <td>JENIS KELAMIN</td><td><input type="text" name="jkel"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>PESAN</td><td><input type="textarea" name="pesan"></td>
            </tr>
            <tr>
